 ...
 */
public class MyAcceptCarListAdapter extends TTSBaseAdapterRecyclerView<ApplyBean> {
    private List<ApplyBean> mData;
    private Context context;
    private boolean isBtn;

    public MyAcceptCarListAdapter(Context context, List<ApplyBean> data, boolean isBtn) {
        super(context, data);
