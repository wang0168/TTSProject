...
import chexin.project.tts.chexin.adapter.goodsowner.CollectionCarSourceAdapter;
 ...
 */
public class MyCollectionCarSourceFragment extends BaseFragment {
    private RecyclerViewAutoRefreshUpgraded collectionList;
    private CollectionCarSourceAdapter collectionCarSourceAdapter;
    ...
    private void adapterCollection() {
        ...
        collectionCarSourceAdapter = new CollectionCarSourceAdapter(getActivity(), mData);
        collectionList.setAdapter(collectionCarSourceAdapter);
