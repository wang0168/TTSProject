 ...
 */
public class GoodsHistoryOrderFragment extends BaseFragment {
    ...
    private void adapterCar() {
        ...
        orderListAdapter.setActionOnClickListener(new CarOrderListAdapter.ActionOnClickListener() {
            ...
            public void doAction(View v, int postion) {
                ...
                startActivity(new Intent(new Intent(getActivity(), AssessmentActivity.class).
                        putExtra("from", "1").putExtra("order_id", order_id).putExtra("face", mData.get(postion).
