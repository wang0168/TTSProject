...
import chexin.project.tts.chexin.adapter.carowner.CollectionGoodsSourceAdapter;
 ...
 */
public class MyCollectionGoodsSourceFragment extends BaseFragment {
    private RecyclerViewAutoRefreshUpgraded collectionList;
    private CollectionGoodsSourceAdapter collectionGoodsMemberAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return setContentView(R.layout.my_collection_goods_source_fragment, inflater, container, savedInstanceState);
    }
    ...
    private void adapterCollection() {
        ...
        collectionGoodsMemberAdapter = new CollectionGoodsSourceAdapter(getActivity(), mData);
        ...
        collectionGoodsMemberAdapter.setOnItemClickListener(new TTSBaseAdapterRecyclerView.OnItemClickListener() {
            ...
            public void onClick(View itemView, int position) {
                startActivityForResult(new Intent(getActivity(), GoodsDetailsActivity.class).putExtra("data", mData.get(position).getGoodsBean()), 1001);
            }
