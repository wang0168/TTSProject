...
import tts.moudle.huanxinapi.video.utils.Utils;
...
public class RecorderVideoActivity extends Activity
	...
	public void onClick(View v) {
		if (v.getId() == R.id.switch_btn) {
			switchCamera();
		} else if (v.getId() == R.id.recorder_start) {
			if (!startRecording())
				return;
			...
			chronometer.start();
		} else if (v.getId() == R.id.recorder_stop) {
			...
			new AlertDialog.Builder(this).setMessage(R.string.Whether_to_send)
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			new AlertDialog.Builder(this).setMessage(st3)
					.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this).setTitle(R.string.prompt).setMessage(R.string.Open_the_equipment_failure)
				.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
	...
	private void showNoSDCardDialog() {
		new AlertDialog.Builder(this).setTitle(R.string.prompt).setMessage("No sd card!")
				.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
