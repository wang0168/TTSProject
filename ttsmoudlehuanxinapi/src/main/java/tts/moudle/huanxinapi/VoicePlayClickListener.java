...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    public void playVoice(String filePath) {
        ...
        if (HXBaseApplication.getInstance().getSettingMsgSpeaker()) {
    ...
    private void showAnimation() {
        ...
        if (message.direct == EMMessage.Direct.RECEIVE) {
            //voiceIconView.startAnimation(AnimationUtils.loadAnimation(activity, R.anim.voice_from_icon));
            voiceIconView.setImageResource(R.drawable.voice_from_icon);
        } else {
            //voiceIconView.startAnimation(AnimationUtils.loadAnimation(activity, R.anim.voice_to_icon));
